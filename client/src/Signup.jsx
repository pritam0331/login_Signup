...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    axios.post('http://localhost:3001/register',{name,email,password}) // axios.port('path/database name',parameters)
    ...
    <>
      <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-13 bg-black">
        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
              <Link to="/login"
                className="mt-3 flex w-full justify-center rounded-md bg-teal-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Alredy a user
              </Link>
            </div>
